...
class UserAgentUtils:
    ...
    @staticmethod
    @cached(region="kiritop115strmhelper_util_real_app_ver", ttl=60 * 60, skip_none=True)
    ...
    @staticmethod
    @cached(
        region="kiritop115strmhelper_util_user_agent_u115_ios", ttl=60 * 60, skip_none=True
    )
