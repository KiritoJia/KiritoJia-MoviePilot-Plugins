...
class IdPathCache:
    ...
    def __init__(self, maxsize=128):
        ...
        self.id_to_dir = LRUCache(
            region="kiritop115strmhelper_id_path_cache_id_to_dir",
            maxsize=maxsize,
        )
        self.dir_to_id = LRUCache(
            region="kiritop115strmhelper_id_path_cache_dir_to_id",
            maxsize=maxsize,
        )
...
class R302Cache:
    ...
    def __init__(self, maxsize=8096):
        ...
        self.region = "kiritop115strmhelper_r302_cache"
...
rename_media_fields_cacher = TTLCache(
    region="kiritop115strmhelper_rename_media_fields", maxsize=2048, ttl=36000
)
