...
.source-skeleton, .source-list { overflow: hidden; border: 1px solid rgba(var(--v-border-color), 0.08); border-radius: 0.5rem; background: rgb(var(--v-theme-surface)); box-shadow: 0 0.25rem 1.125rem rgba(30, 26, 48, 0.07); }
