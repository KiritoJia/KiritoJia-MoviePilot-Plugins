...
.search-controls, .search-results { min-width: 0; border: 1px solid rgba(var(--v-border-color), 0.08); border-radius: 0.5rem; background: rgb(var(--v-theme-surface)); box-shadow: 0 0.25rem 1.125rem rgba(30, 26, 48, 0.07); }
.search-controls { padding: 1rem; }
.search-results { min-height: 24rem; padding: 1rem; }
...
.source-results { overflow: hidden; border: 1px solid rgba(var(--v-border-color), var(--v-border-opacity)); border-radius: 0.375rem; }
...
@media (max-width: 959px) { .search-layout { grid-template-columns: 1fr; } .search-controls, .search-results { padding: 0.85rem; } }
